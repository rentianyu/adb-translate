...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/adb-translate/flexsearch.min.js');loadScript('/adb-translate/en.search-data.min.eb4b8e7650f2627008fb3181d92c0335fd4f815eb96d184d8c8db28920630a2d.js',function(){input.required=false;search();});}

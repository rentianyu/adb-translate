...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/adb-translate/flexsearch.min.js');loadScript('/adb-translate/en.search-data.min.c66000ef1d61d5c3fc15a78f8eeffcaa0c720e6cf7bdcd1a9c0d5fd00869551f.js',function(){input.required=false;search();});}
